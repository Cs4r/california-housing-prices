...
print(paste("La variable housing_median_age tiene", length(boxplot.stats(houses$housing_median_age)$out), "valores perdidos"))

print(paste("La variable total_rooms tiene", length(boxplot.stats(houses$total_rooms)$out), "valores perdidos"))

print(paste("La variable total_bedrooms tiene", length(boxplot.stats(houses$total_bedrooms)$out), "valores perdidos"))

print(paste("La variable population tiene", length(boxplot.stats(houses$population)$out), "valores perdidos"))

print(paste("La variable households tiene", length(boxplot.stats(houses$households)$out), "valores perdidos"))

print(paste("La variable median_income tiene", length(boxplot.stats(houses$median_income)$out), "valores perdidos"))

print(paste("La variable median_house_value tiene", length(boxplot.stats(houses$median_house_value)$out), "valores perdidos"))
